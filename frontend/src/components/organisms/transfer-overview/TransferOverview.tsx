...
export const TransferOverview: React.FC<Props> = ({
  ...
  const [ccdPrice, setCcdPrice] = useState(0);
        ...
        <div>
          ...
          <StyledProcessWrapper>
            ...
            <Text
              ...
              fontLetterSpacing="0"
            >
              {`${isWithdraw ? "" : "~"}${isWithdraw ? "It will be visible when signing the transaction." : gasFee} ${isWithdraw ? "" : "ETH"
                } ${isWithdraw ? "" : "("} ${isWithdraw ? "" : (gasFee * ethPrice).toFixed(4)} ${isWithdraw ? "" : "USD)"}`}
            </Text>
          </StyledProcessWrapper>
