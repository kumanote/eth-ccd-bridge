          ...
          <div>
            <StyledProcessWrapper>
              ...
              <StyledCircleWrapper index={1}>
                <StyledCircle
                  completed={
                    isWithdraw ? transferStatus > 0 : transferStatus > 1
                  }
                />
                <Text
                  fontFamily="Roboto"
              ...
              <StyledCircleWrapper index={2}>
                <StyledCircle
                  completed={
                    isWithdraw ? transferStatus > 1 : transferStatus > 3
                  }
                />
                <Text
                  fontFamily="Roboto"
              ...
              <StyledCircleWrapper index={3}>
                <StyledCircle
                  completed={
                    isWithdraw ? transferStatus > 2 : transferStatus > 4
                  }
                />
                <Text
                  fontFamily="Roboto"
            ...
            <TransferAmountWrapper>
              ...
              <Text fontSize="16" fontColor="White" fontWeight="bold">
                {amount}{" "}
                {isWithdraw ? token?.ccd_token?.name : token?.eth_token?.name}
              </Text>
            </TransferAmountWrapper>
          </div>
          <InfoContainer
            processed={isWithdraw ? transferStatus > 2 : transferStatus > 4}
          >
            <Image
              src={Hourglass.src}
              width={16.56}
