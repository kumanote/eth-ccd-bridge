...
const useWethContract = () => {
    ...
    const getBalance = async () => {
        ...
        const wethContract = new ethers.Contract(addresses.weth, WETH_ABI, provider);
    ...
    const estimateGas = async (address: string, amount: number) => {
        ...
        const gasLimit = (await wethContract.estimateGas.transfer(address, amount.toString())).toNumber();
    ...
    const allowance = async (address: string = "0x05f7c98458440b626d345510f0144686b34ccE48") => {
    ...
    const approve = async (address: string = "0x05f7c98458440b626d345510f0144686b34ccE48") => {
        const signer = context.library?.getSigner();
