...
pub mod erc_20 {
    ...
    impl<M> Clone for Erc20<M> {
        fn clone(&self) -> Self { Erc20(self.0.clone()) }
    }
    ...
    /// with signature `allowance(address,address)` and selector `[221, 98, 237,
    /// 62]`
    #[derive(
        Clone,
        Debug,
    ...
    /// signature `approve(address,uint256)` and selector `[9, 94, 167, 179]`
    #[derive(
        Clone,
        Debug,
        Eq,
    ...
    /// with signature `balanceOf(address)` and selector `[112, 160, 130, 49]`
    #[derive(
        Clone,
        Debug,
        Eq,
    ...
    /// signature `decimals()` and selector `[49, 60, 229, 103]`
    #[derive(
        Clone,
        Debug,
        Eq,
    ...
    /// signature `name()` and selector `[6, 253, 222, 3]`
    #[derive(
        Clone,
        Debug,
        Eq,
    ...
    /// signature `symbol()` and selector `[149, 216, 155, 65]`
    #[derive(
        Clone,
        Debug,
        Eq,
    ...
    /// with signature `totalSupply()` and selector `[24, 22, 13, 221]`
    #[derive(
        Clone,
        Debug,
        Eq,
    ...
    /// signature `transfer(address,uint256)` and selector `[169, 5, 156, 187]`
    #[derive(
        Clone,
        Debug,
        Eq,
    ...
    impl ::std::convert::From<AllowanceCall> for Erc20Calls {
        fn from(var: AllowanceCall) -> Self { Erc20Calls::Allowance(var) }
    }
    impl ::std::convert::From<ApproveCall> for Erc20Calls {
        fn from(var: ApproveCall) -> Self { Erc20Calls::Approve(var) }
    }
    impl ::std::convert::From<BalanceOfCall> for Erc20Calls {
        fn from(var: BalanceOfCall) -> Self { Erc20Calls::BalanceOf(var) }
    }
    impl ::std::convert::From<DecimalsCall> for Erc20Calls {
        fn from(var: DecimalsCall) -> Self { Erc20Calls::Decimals(var) }
    }
    impl ::std::convert::From<DecreaseAllowanceCall> for Erc20Calls {
        fn from(var: DecreaseAllowanceCall) -> Self { Erc20Calls::DecreaseAllowance(var) }
    }
    impl ::std::convert::From<IncreaseAllowanceCall> for Erc20Calls {
        fn from(var: IncreaseAllowanceCall) -> Self { Erc20Calls::IncreaseAllowance(var) }
    }
    impl ::std::convert::From<NameCall> for Erc20Calls {
        fn from(var: NameCall) -> Self { Erc20Calls::Name(var) }
    }
    impl ::std::convert::From<SymbolCall> for Erc20Calls {
        fn from(var: SymbolCall) -> Self { Erc20Calls::Symbol(var) }
    }
    impl ::std::convert::From<TotalSupplyCall> for Erc20Calls {
        fn from(var: TotalSupplyCall) -> Self { Erc20Calls::TotalSupply(var) }
    }
    impl ::std::convert::From<TransferCall> for Erc20Calls {
        fn from(var: TransferCall) -> Self { Erc20Calls::Transfer(var) }
    }
    impl ::std::convert::From<TransferFromCall> for Erc20Calls {
        fn from(var: TransferFromCall) -> Self { Erc20Calls::TransferFrom(var) }
    }
    /// Container type for all return fields from the `allowance` function with
    /// signature `allowance(address,address)` and selector `[221, 98, 237, 62]`
    #[derive(
        Clone,
        Debug,
        Eq,
    ...
    /// signature `balanceOf(address)` and selector `[112, 160, 130, 49]`
    #[derive(
        Clone,
        Debug,
        Eq,
